...
-------------------------------------------------------------
在vuexInit中，将new Vue()时传入的store设置到this对象的$store属性上，注意！因为每个组件都会被渲染，在上面使用mixin进行了混入，所以vuexInit在组建被创建之前都会被调用。
